...
const data = [
  ...
  date:new Date() },
  { id:5, userId:'2',
  text:'Mensaje de prueba para checkear los espaciados, textos comas etc. Lo que venga para hacer la caja mas realista ! ?$ 1243 2244 44 -- @.', image:'https://images.unsplash.com/photo-1474511320723-9a56873867b5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=872&q=80',
  date:new Date() }
]
